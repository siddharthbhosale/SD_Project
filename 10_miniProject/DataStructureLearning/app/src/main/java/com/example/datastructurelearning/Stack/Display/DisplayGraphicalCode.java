...
public class DisplayGraphicalCode extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        pushGraphicLayout = view.findViewById(R.id.displayGraphicalLayout);
    ...
    private void showAnimations() {
        ...
        operationTextView.setText("The link is first printed");
        ...
        new CountDownTimer(2000, 1000) {
            ...
            public void onFinish() {
                ...
                operationTextView.setText("The Node is then printed");
